...
<div class="card-deck pb-4">
  <div class="card p-4">
    ...
    <h3 class="card-title">Saurabh Tanwar</h3>
        ...
        <p class="card-text">itesaurabh@yahoo.com</p>
  ...
  <div class="card p-4">
    ...
    <h3 class="card-title">Lalit Patidar</h3>
        ...
        <p class="card-text">lytt10017@gmail.com </p>
...
<div class="card-deck pb-4">
  <div class="card p-4">
    ...
    <h3 class="card-title">Kajal Singh</h3>
        ...
        <p class="card-text">kajalsingh1616@gmail.com</p>
  ...
  <div class="card p-4">
    ...
    <h3 class="card-title">Praveen Yadav</h3>
        ...
        <p class="card-text">praveenyadavtak@gmail.com</p>
